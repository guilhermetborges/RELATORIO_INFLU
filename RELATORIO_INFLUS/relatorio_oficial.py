...
CUPONS_PERMITIDOS = {
    "AGUILERA", "ALEZAMBELLI", "AMANDALENCI", "ANGEL", "AYENAJU", "AYLABOCCI",
    "BELLASARDI", "BIABRUMATTI", "BRENDINHA", "CLARISSA", "DUDADALLA",
    "DUDAMILLER", "DUDASALERNO", "GABIMARUAN", "GABISOARES", "GABISQ",
    "GABITAVEIRA", "GIGALIZA", "GIMARTINISI", "GIOLIVEIRA", "HELOYOHANA",
    "ISAHARAGAO", "ISAMARTE", "JETISOVEC", "JUALVARENGA", "JULIASOUTO",
    "JUNEVES", "LALAMOUNIER", "LALOURENCA", "LARAB", "LARABALIEIRO", "LARAF",
    "LARILODI", "LARILUN", "LARISSA", "LAURA", "LEBARBUTTI", "LISBELLA",
    "MADUG", "MANUCUNHA", "MANUZINHASTAR", "MARIRODRIGUES", "MARISALES",
    "MDM", "NANDA", "NATTY", "NICMARCONDES", "PAMSBRUZZI", "RENATASIMAS",
    "SOPHIAROCHA", "THAISCHAGAS", "TOZETTO", "TRIZ", "VIEGASCAROL",
    "ZWISOCA",

    # já existentes e que não estavam na lista inicial
    "CAMSTM", "GIRLBLOGGER", "SOPHIALUZ", "MAVINAKA", "GIOAGUILERA", "MAYA"
}
